...
import (
	...
	versioned "code-generator-test/pkg/generated/clientset/versioned"
	internalinterfaces "code-generator-test/pkg/generated/informers/externalversions/internalinterfaces"
	v1 "code-generator-test/pkg/generated/listers/hjjzs/v1"
	"context"
	time "time"
	...
	return cache.NewSharedIndexInformer(
		&cache.ListWatch{
			ListFunc: func(options metav1.ListOptions) (runtime.Object, error) {
				...
				return client.HjjzsV1().Foos(namespace).List(context.TODO(), options)
			},
			WatchFunc: func(options metav1.ListOptions) (watch.Interface, error) {
				if tweakListOptions != nil {
					tweakListOptions(&options)
				}
				return client.HjjzsV1().Foos(namespace).Watch(context.TODO(), options)
			},
		},
		&hjjzsv1.Foo{},
		resyncPeriod,
...
func (f *fooInformer) Informer() cache.SharedIndexInformer {
	return f.factory.InformerFor(&hjjzsv1.Foo{}, f.defaultInformer)
}
